...
1. Enter the name of the connector as **ghaz-github (1)**, select your **Subscription (2)**, select **Resource Group (3)**, and then select **Region (3)**. Select **Next: Configure access > (5)**.
...
1. After some minutes, you will see the GitHub connector on the **Environment settings** page. It takes about 15 minutes.
